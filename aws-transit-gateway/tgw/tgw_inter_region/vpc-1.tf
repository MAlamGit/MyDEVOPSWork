...
module "vpc" {
  ...
  vpc-public-subnet-cidr              = ["30.30.1.0/24","30.30.2.0/24"]
  vpc-private-subnet-cidr             = ["30.30.4.0/24","30.30.5.0/24"]
  vpc-database_subnets-cidr           = ["30.30.7.0/24", "30.30.8.0/24"]
  tgw-route-cidr                      =  "30.31.0.0/16"
