...
module "vpc-home" {
  ...
  vpc-public-subnet-cidr              = ["192.168.1.0/24","192.168.2.0/24"]
  vpc-private-subnet-cidr             = ["192.168.4.0/24","192.168.5.0/24"]
  vpc-database_subnets-cidr           = ["192.168.7.0/24", "192.168.8.0/24"]
  tgw-route-cidr                      = "10.11.0.0/16"
